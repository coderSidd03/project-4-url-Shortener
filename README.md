...
Some of the use cases for URL shortening is to optimize links shared across users, easy tracking of individual links and sometimes hiding the affiliated original URLs.
...
- To test these apis create a new collection in Postman named Project 4 Url Shortener
